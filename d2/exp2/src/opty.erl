...
start(Clients, Entries, Reads, Writes, Time, Access) ->
    register(s, server:start(Entries)),
		Conf = [Clients, Entries, Reads, Writes, Time, Access],
    L = startClients(Clients, [], Entries, Reads, Writes, Conf),
...
startClients(Clients, L, Entries, Reads, Writes, Conf) ->
    Pid = client:start(Clients, Entries, Reads, Writes, Conf, s),
